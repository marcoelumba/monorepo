...
![Alt text](/screenshots/postgres_word_mapping.png?=10x10 "Word Mapping")
<br>

![Alt text](/screenshots/postgres_number_mapping.png?=10x10 "Number Mapping")
...
![Alt text](/screenshots/postgres_stg_customer_engagement.png?=10x10 "Staging Customer Engagement")
...
![Alt text](/screenshots/snowflake_stg_customer_engagement.png?=50x20 "Staging Customer Engagement")
<br>

![Alt text](/screenshots/snowflake_customer_engagement_summary.png?=50x20 "Customer Engagement Summary")
